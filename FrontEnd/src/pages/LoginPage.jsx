        ...
        <div className="body-container-content">
          <form action="" className="login-form">
            ...
            <div className="email-div-login">
              <label className='label-input'  htmlFor="Email-login">Email</label>
              <input value={email} onChange={(e) => setEmail(e.target.value)} id="Email-login" type="text" />
            </div>
            <div className="password-div-login">
              <div className="password-div-login-content">
                ...
                <input className='input-password-style' value={password} onChange={(e)  => setPassword(e.target.value)} id="Password-login" type={passwordIsVisible? "text" :"password"} />
              ...
              <div className="password-div-login-checks">
                <div className='login-check-div'>
                  <input type="checkbox" className="checkbox-label" name="" id="rememberMe" />
            ...
            <div className="login-div-button">
              ...
              <p className='not-registered-text'>
                Not registered yet? <Link className='create-account' to="/">Create an account</Link>
              </p>
            </div>
          </form>
        </div>
